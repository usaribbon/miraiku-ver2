                        ...
                        <div class="quality">
                            <div class="quality__item">
                                <div class="quality__item__inner">
                                    ...
                                    <figure><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/index/quality1<?php echo $is_2x?>.png" alt="安全な食材を使ったおいしい給食" /></figure>
                            ...
                            <div class="quality__item">
                                <div class="quality__item__inner">
                                    ...
                                    <figure><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/index/quality2<?php echo $is_2x?>.png" alt="木をふんだんに使った快適な保育室" /></figure>
                            ...
                            <div class="quality__item">
                                <div class="quality__item__inner">
                                    ...
                                    <figure><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/index/quality3<?php echo $is_2x?>.png" alt="病児・病後児の保育も可能" /></figure>
                            ...
                            <div class="quality__item">
                                <div class="quality__item__inner">
                                    ...
                                    <figure><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/index/quality4<?php echo $is_2x?>.png" alt="保育料実質０円" /></figure>
...
<?php if ($the_query->have_posts()):?>
<?php while ( $the_query->have_posts() ) : $the_query->the_post();?>
                        <div class="p-todayslunch u-frame--arc is-green">
                            <div class="grid">
                                <div class="image grid__item">
                                    <figure class="image u-frame--brackets"><?php the_post_thumbnail( 'image830x630' ); ?></figure>
                                </div>
                                <div class="content grid__item">
                                    <header class="p-todayslunch-header">
                                        <h2 class="primary">今日のおやつ</h2>
                                        <p class="secondary">Today's snack</p>
                                    </header>
                                    <div class="recipe p-editor">
                                        <div class="p-editor">
                                            <?php the_content();?>
                            ...
                            <p class="u-align--center"><a href="https://chiikihoiku.net/snack/" class="c-button c-button--l c-button--seagreen">これまでのおやつ</a></p>
                        </div>
<?php endwhile; ?>
<?php endif;?>
<?php wp_reset_query();?>
                        ...
                        <div class="about-miraiku">
                            ...
                            <div class="about-miraiku__item">
                                <a href="<?php echo home_url( '/history' ); ?>">
                                    <figure><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/index/about5@2x.jpg" alt="" /></figure>
                                    <h3 class="heading">みらいくの歴史</h3>
                                </a>
                            </div>
                        </div>
                    </div>
